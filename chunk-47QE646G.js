import{a as ee}from"./chunk-GP73AJGP.js";import{a as Z}from"./chunk-DTQAAS3L.js";import{fa as W,ga as y,ha as X,la as Y}from"./chunk-XZCLXVAJ.js";import{i as H,l as U,q as G,w as J}from"./chunk-ZQQG3XOR.js";import{$b as f,Bc as K,Da as M,Ea as C,Kb as _,Nc as L,Rb as c,Sb as h,Tb as g,Ub as j,Yb as x,Zb as I,_a as P,cb as p,cd as q,dc as u,ea as $,fa as E,fc as r,gc as z,hc as A,ic as w,ja as V,kc as T,lc as k,mc as O,nc as R,pb as S,pc as B,qa as s,qb as D,qc as d,ra as l,rc as N,sc as Q,tb as F,vb as m,xb as b}from"./chunk-JEBMXVCV.js";var ne=["removeicon"],te=["*"];function oe(e,a){if(e&1){let i=f();h(0,"img",4),u("error",function(t){s(i);let o=r();return l(o.imageError(t))}),g()}if(e&2){let i=r();c("src",i.image,P)("alt",i.alt)}}function re(e,a){if(e&1&&j(0,"span",6),e&2){let i=r(2);d(i.icon),c("ngClass","p-chip-icon"),_("data-pc-section","icon")}}function ce(e,a){if(e&1&&m(0,re,1,4,"span",5),e&2){let i=r();c("ngIf",i.icon)}}function ae(e,a){if(e&1&&(h(0,"div",7),N(1),g()),e&2){let i=r();_("data-pc-section","label"),p(),Q(i.label)}}function pe(e,a){if(e&1){let i=f();h(0,"span",11),u("click",function(t){s(i);let o=r(3);return l(o.close(t))})("keydown",function(t){s(i);let o=r(3);return l(o.onKeydown(t))}),g()}if(e&2){let i=r(3);d(i.removeIcon),c("ngClass","p-chip-remove-icon"),_("data-pc-section","removeicon")("aria-label",i.removeAriaLabel)}}function se(e,a){if(e&1){let i=f();h(0,"TimesCircleIcon",12),u("click",function(t){s(i);let o=r(3);return l(o.close(t))})("keydown",function(t){s(i);let o=r(3);return l(o.onKeydown(t))}),g()}if(e&2){let i=r(3);d("p-chip-remove-icon"),_("data-pc-section","removeicon")("aria-label",i.removeAriaLabel)}}function le(e,a){if(e&1&&(x(0),m(1,pe,1,5,"span",9)(2,se,1,4,"TimesCircleIcon",10),I()),e&2){let i=r(2);p(),c("ngIf",i.removeIcon),p(),c("ngIf",!i.removeIcon)}}function me(e,a){}function _e(e,a){e&1&&m(0,me,0,0,"ng-template")}function he(e,a){if(e&1){let i=f();h(0,"span",13),u("click",function(t){s(i);let o=r(2);return l(o.close(t))})("keydown",function(t){s(i);let o=r(2);return l(o.onKeydown(t))}),m(1,_e,1,0,null,14),g()}if(e&2){let i=r(2);_("data-pc-section","removeicon")("aria-label",i.removeAriaLabel),p(),c("ngTemplateOutlet",i.removeIconTemplate||i._removeIconTemplate)}}function ge(e,a){if(e&1&&(x(0),m(1,le,3,2,"ng-container",3)(2,he,2,3,"span",8),I()),e&2){let i=r();p(),c("ngIf",!i.removeIconTemplate&&!i._removeIconTemplate),p(),c("ngIf",i.removeIconTemplate||i._removeIconTemplate)}}var fe=({dt:e})=>`
.p-chip {
    display: inline-flex;
    align-items: center;
